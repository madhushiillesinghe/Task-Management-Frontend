...
import IconPrivacyPolicy from "@/public/icons/IconPrivacy";
...
function MiniSidebar() {
  ...
  const navItems = [
    ...
    {
      icon: <IconPrivacyPolicy strokeColor={getStrokeColor("/policy")} />,
      title: " policy",
      link: " policy",
    },
  ];
  return (
    <div className="basis-[5rem] flex flex-col bg-[#f9f9f9]">
      <div className="flex items-center justify-center h-[5rem]">
        <Image src="/logo.jpg" width={98} height={88} alt="logo" />
      </div>
